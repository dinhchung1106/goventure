(function($) {
    ...
    // Call the function once on initial load if needed (optional, but good practice)
    $(document).ready(function() {
        window.initScrollToTarget();
        window.initOffcanvasMenu();
        window.initMobileMenu(); // Add call here
        window.initBrandSlider(); // Add call here
    });
    ...
    /*===========================================
    	=           Scroll Up  	         =
    =============================================*/
    // Wrapped scroll-to-target logic in a function
    ...
    // Call the function once on initial load (for static parts of the HTML if any)
    $(document).ready(function() {
        window.initScrollToTarget();
    });
    ...
    =     Offcanvas Menu      =
    =============================================*/
    window.initOffcanvasMenu = function() {
